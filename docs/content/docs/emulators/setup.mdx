...
[retroarch_cores.md](https://github.com/romm-streaming/romm-broker/blob/master/docs/retroarch_cores.md)
summarizes what each core this repo maps a platform to actually needs; for the
authoritative per-core detail, defer to libretro's own
